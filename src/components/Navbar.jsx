            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-14">
                <div className="grid grid-cols-2 md:grid-cols-3 items-center h-16 md:h-20">
                    ...
                    <div className="hidden lg:flex justify-end">
                        <button
                            className="px-6 py-2 text-base rounded-full border border-[#ff9000] text-[#ff9000] hover:bg-[#ff9000] hover:text-black transition-all duration-200"
                    ...
                    <div className="lg:hidden flex justify-end">
                        <button
                            ...
                            className="p-2 text-gray-300 hover:text-[#ff9000] transition-colors"
                        >
